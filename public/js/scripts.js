...
(function ($) {
  ...
  $(".subscribe-form input").jqBootstrapValidation({
    ...
    submitSuccess: function ($form, event) {
      ...
      $.ajax({
        success: function () {
          $("#subscribe-success").html("<div className='alert alert-success'>");
          $("#subscribe-success > .alert-success")
            .html(
              "<button type='button' className='close' data-dismiss='alert' aria-hidden='true'>&times;"
            )
            .append("</button>");
          $("#subscribe-success > .alert-success").append(
            "<strong>Your message has been sent. </strong>"
          );
          $("#subscribe-success > .alert-success").append("</div>");
        },
      });
    },
  });
  ...
  function init() {
    ...
    var mapOptions = {
      ...
      center: new google.maps.LatLng(40.67, -73.94), // New York           // How you would like to style the map.
