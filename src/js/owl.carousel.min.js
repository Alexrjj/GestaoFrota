  ...
  var l = {
    ...
    buildControls: function () {
      if (!0 === this.options.navigation || !0 === this.options.pagination)
        this.owlControls = f('<div className="owl-controls"/>')
    ...
    buildPagination: function () {
      var a = this;
      a.paginationWrapper = f('<div className="owl-pagination"/>');
    ...
    transitionTypes: function (a) {
      this.outclassName = "owl-" + a + "-out";
      this.inclassName = "owl-" + a + "-in";
    },
