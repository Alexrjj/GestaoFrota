            ...
            a(l).bind("submit", function (e) {
              ...
              r
                ...
                r.each(function (e, t) {
                  ...
                  r.hasClass("warning") &&
                    (r.removeClass("warning").addClass("error"), n++);
                }),
                  ...
                  ? (t.options.preventSubmit && e.preventDefault(),
                    ...
                    a.isFunction(t.options.submitError) &&
                      t.options.submitError(
                        i,
                        e,
                        r.jqBootstrapValidation("collectErrors", !0)
                      ))
                  : (i.removeClass("error"),
              ...
              a.each(d, function (i, n) {
                ...
                if (
                  ...
                  a.each(t.validatorTypes, function (t, i) {
                    void 0 === h[t] && (h[t] = []),
                      l ||
                        void 0 === e.data("validation" + n + r(i.name)) ||
                        (h[t].push(
                          a.extend(
                            !0,
                            { name: r(i.name), message: o },
                            i.init(e, n)
                          )
                        ),
                        (l = !0));
                    ...
                    a.each(h, function (i, o) {
                      (r ||
                        ...
                        (t.validatorTypes[i].blockSubmit &&
                          n &&
                          n.submitting)) &&
                        a.each(o, function (a, n) {
                          t.validatorTypes[i].validate(e, r, n) &&
                            s.push(n.message);
                        });
                    }),
                    s
                ...
                e.bind(
                  ...
                  function (i, r) {
                    ...
                    n.find("input,textarea,select").each(function (t, i) {
                      ...
                      if (
                        (a.each(
                          a(i).triggerHandler("validation.validation", r),
                          function (a, e) {
                            c.push(e);
                          }
                        ),
      ...
      validatorTypes: {
            ...
            if (i.lastFinished === !0) {
              ...
              t(i.callback, window, a, e, function (a) {
                n.lastValue === a.value &&
                  ...
                  (n.lastFinished = !0),
                  r.data("validation" + n.validatorName + "Message", n.message),
                  setTimeout(function () {
        ...
        ajax: {
          ...
          validate: function (e, t, i) {
            return "" + i.lastValue == "" + t && i.lastFinished === !0
              ? i.lastValid === !1
              : (i.lastFinished === !0 &&
                  ((i.lastValue = t),
                  (i.lastValid = !0),
